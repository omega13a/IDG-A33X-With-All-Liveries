...
This error occurs if you are attempting to use this IDG Aircraft on a version of FlightGear that is too old. See [INSTALL.md](https://github.com/it0uchpods/IDG-A33X/blob/master/INSTALL.md) for more information.
...
Starting in air is [not possible with this aircraft](https://github.com/it0uchpods/IDG-A33X/issues/84#issuecomment-475035478).
...
Please use our [issues page](https://github.com/it0uchpods/IDG-A33X/issues/new) to report bugs. Please fill out the template there to the best of your knowledge. Issues submitted with blank templates will be closed.
...
First of all, did you ensure that the bug is reported on our [issues page](https://github.com/it0uchpods/IDG-A33X/issues/new)? If not, please do so (see also questions above on how to report them)!
...
Increasing the simulation speed is quite tricky for the simulator. Depending on hardware capabilities it can be very stressful and the algorithms behind the scenes can be challenged quite heavily. If the simulation is running faster than the corresponding algorithms can be computed, many funny (or even [ugly things](https://github.com/it0uchpods/IDG-A33X/issues/86#issuecomment-478328407)) may happen. **IDG suggests not setting simulation speed above 4x or below 1/2x at any time**.

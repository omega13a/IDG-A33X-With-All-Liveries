...
var rendering_dlg = gui.Dialog.new("sim/gui/dialogs/rendering/dialog", "Aircraft/IDG-A33X/AircraftConfig/rendering.xml");
spinning.start();
init_dlg.open();

http.load("https://raw.githubusercontent.com/Octal450/IDG-A33X/master/revision.txt").done(func(r) setprop("/systems/acconfig/new-revision", r.response));
